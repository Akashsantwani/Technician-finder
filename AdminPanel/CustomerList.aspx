<%@ Page Title="" Language="C#" MasterPageFile="~/Content/MasterPage.master" AutoEventWireup="true" CodeFile="CustomerList.aspx.cs" Inherits="AdminPanel_CustomerList" %>
                        ...
                        <div class="kt-widget kt-widget--user-profile-3">
                            <div class="kt-widget__top">
                                ...
                                <div class="kt-widget__content">
                                    ...
                                    <div class="kt-widget__info">
                                        <div class="kt-widget__desc">
                                            <asp:Label runat="server" ID="lblCity" Text="City: "></asp:Label><asp:Label runat="server" ID="Label2" Text='<%#Eval("CityName") %>' />
                                        </div>
                                    </div>
                                    <div class="kt-widget__info">
                                        <div class="kt-widget__desc">
                                            <asp:Label runat="server" ID="lbldate" Text="Registered on " /><asp:Label runat="server" ID="lblRegistrationDate" Text='<%#Eval("RegistrationDate") %>' />
                                        </div>
                                    </div>
                                </div>
                            </div>
